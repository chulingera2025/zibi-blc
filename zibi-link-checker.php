...
require_once ZIBI_BLC_PATH . 'admin/export-email-page.php'; // 新增：邮箱导出页面
...
require_once ZIBI_BLC_PATH . 'includes/background.php'; // 新增：后台任务逻辑
